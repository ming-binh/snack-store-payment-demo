 ...
 *
 * type: payment_success | payment_failed | refund_approved | refund_rejected |
 * order_confirmed | order_cancelled | system channel: in_app (luôn có) — email
 * / sms là UI-only trong demo này
 */
public class Notification {
    ...
    public String getBadgeClass() {
        ...
        return switch (type) {
            case "payment_success", "refund_approved", "order_confirmed" ->
                "badge-success";
            case "payment_failed", "refund_rejected", "order_cancelled" ->
                "badge-danger";
            default ->
                "badge-neutral";
        };
